...
export default function Navbar() {
  ...
  const fullName = user ? `${user.first_name} ${user.last_name}` : 'Dylan Field';
  ...
  const toggleProfileDropdown = (e) => {
    ...
    setNotifyDropdownOpen(false); // Close other dropdown
  };
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              <li className="nav-item _header_nav_item">
                <Link className="nav-link _header_nav_link_active _header_nav_link" aria-current="page" to="/">
              ...
              <li className="nav-item _header_nav_item">
                ...
                >
                  ...
                  <div 
                    id="_notify_drop" 
                    className={`_notification_dropdown ${notifyDropdownOpen ? 'show' : ''}`}
            ...
            <div className="_header_nav_profile">
              ...
              <div 
                id="_prfoile_drop" 
                className={`_nav_profile_dropdown _profile_dropdown ${profileDropdownOpen ? 'show' : ''}`}
                onClick={(e) => e.stopPropagation()}
              >
                      ...
                      <div className="_nav_drop_info">
                        <span>
                          <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="none" viewBox="0 0 19 19">
                            <path stroke="#377DFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6.667 18H2.889a1.889 1.889 0 01-1.889-1.889V2.89A1.889 1.889 0 012.889 1h3.778M13.277 14.222L18 9.5l-4.723-4.722M18 9.5H6.667"/>
                          </svg>			
                        </span>
                        Log Out		
                      </div>
