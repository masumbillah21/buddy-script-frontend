    ...
    <div className="_feed_inner_timeline_cooment_area">
      ...
      <div className="_feed_inner_comment_box">
        <form className="_feed_inner_comment_box_form" onSubmit={handleAddComment}>
          ...
          <div className="_feed_inner_comment_box_icon">
            ...
            <button type="button" className="_feed_inner_comment_box_icon_btn" aria-label="Add Media">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16">
      ...
      <div className="_timline_comment_main">
        ...
        <div className="_previous_comment">
          ...
          >
            {showPrevious ? 'Hide previous comments' : 'View 4 previous comments'}
          </button>
        </div>

        {/* Previous mock comments (hidden by default) */}
        {showPrevious && (
          <div style={{ opacity: 0.8, borderLeft: '2px dashed #ccc', paddingLeft: '10px' }}>
                ...
                <div className="_comment_details">
                  <div className="_comment_details_top">
                    <div className="_comment_name">
                      <Link to="#">
                        <h4 className="_comment_name_title">Ryan Roslansky</h4>
                      </Link>
                    </div>
                  </div>
                  <div className="_comment_status">
                    <p className="_comment_status_text"><span>Great design, looking forward to the release!</span></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="_comment_main" key={comment.id}>
            ...
            <div className="_comment_area">
              ...
              {replyBoxes[comment.id] && (
                <div className="_feed_inner_comment_box mt-2" style={{ paddingLeft: '20px' }}>
                  <form className="_feed_inner_comment_box_form" onSubmit={(e) => { e.preventDefault(); toggleReplyBox(comment.id); }}>
                    <div className="_feed_inner_comment_box_content">
                      <div className="_feed_inner_comment_box_content_image">
                        <img src="/assets/images/comment_img.png" alt="" className="_comment_img" />
                      </div>
                      <div className="_feed_inner_comment_box_content_txt">
                        <textarea className="form-control _comment_textarea" placeholder="Write a reply..." id="floatingTextareaReply"></textarea>
                      </div>
                    </div>
                  </form>
                </div>
