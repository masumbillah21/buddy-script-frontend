...
export default function SidebarLeft() {
  const [suggestions, setSuggestions] = useState([
    { id: 1, name: 'Steve Jobs', role: 'CEO of Apple', img: '/assets/images/people1.png', connected: false },
    { id: 2, name: 'Ryan Roslansky', role: 'CEO of Linkedin', img: '/assets/images/people2.png', connected: false },
    { id: 3, name: 'Dylan Field', role: 'CEO of Figma', img: '/assets/images/people3.png', connected: false }
  ]);

  const [events, setEvents] = useState([
    { id: 1, date: '10', month: 'Jul', title: 'No more terrorism no more cry', going: false, attendees: 17 },
    { id: 2, date: '10', month: 'Jul', title: 'No more terrorism no more cry', going: false, attendees: 17 }
  ]);
    ...
    setEvents(events.map(e => {
      if (e.id === id) {
        ...
        return {
          ...e,
          going: isGoing,
          attendees: isGoing ? e.attendees + 1 : e.attendees - 1
        };
      }
      return e;
    }));
      ...
      <div className="_layout_left_sidebar_wrap">
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            {suggestions.map(s => (
              <div className="_left_inner_area_suggest_info" key={s.id}>
                <div className="_left_inner_area_suggest_info_box">
                  ...
                  <div className="_left_inner_area_suggest_info_txt">
                    <Link to="#">
                      <h4 className="_left_inner_area_suggest_info_title">{s.name}</h4>
                    </Link>
                    <p className="_left_inner_area_suggest_info_para">{s.role}</p>
                  </div>
                </div>
                <div className="_left_inner_area_suggest_info_link"> 
                  <button 
                    onClick={() => handleConnect(s.id)} 
                    className={`_info_link ${s.connected ? '_connected_active' : ''}`}
              ...
              <div className="_left_inner_event_card_link" key={e.id} style={{ display: 'block', cursor: 'pointer' }}>
                <div className="_left_inner_event_card">
                  ...
                  <div className="_left_inner_event_bottom">
                    <p className="_left_iner_event_bottom">{e.attendees} People Going</p> 
                    <button 
                      onClick={() => handleEventGoing(e.id)} 
                      className={`_left_iner_event_bottom_link ${e.going ? '_going_active' : ''}`}
                      style={{ border: 'none', background: 'none', padding: 0 }}
                    >
                      {e.going ? 'Going ✓' : 'Going'}
                    </button>
